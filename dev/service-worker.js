...
const APP_SHELL=['./','./index.html','./app.js','./logo_data.js','./api-context.js','./feature-compat.js','./features-runtime.js','./navigation-shell.js','./performance-hotfix.js','./manifest.json','./icon-192.png','./icon-512.png','./icon-512-maskable.png'];
