/**
 * APOTEK ANA FARMA — DEV SERVICE WORKER V18.5
 *
 ...
 */
const CACHE_VERSION='ana-farma-dev-v18-5';
...
const APP_SHELL=['./','./index.html','./app.js','./logo_data.js','./api-context.js','./feature-compat.js','./features-runtime.js','./navigation-shell.js','./manifest.json','./icon-192.png','./icon-512.png','./icon-512-maskable.png'];
