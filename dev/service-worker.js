/**
 * APOTEK ANA FARMA — DEV SERVICE WORKER V18.8
 *
 * DEV ONLY. Scope is /dev/ and never touches production root.
 ...
 * - Old DEV cache versions are removed on activate.
 */
const CACHE_VERSION = 'ana-farma-dev-v18-8';
